...
st.set_page_config(page_title="AI StudyMate", layout="centered") st.title("AI StudyMate: Your Smart Learning Companion")
...
if st.button("Start 25-Minute Study Session"):
    ...
    time.sleep(2)  # Simulate with short delay for demo
